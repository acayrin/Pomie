// ===================================== Process arguments and execute LevelGuide.js =====================================
/**
list leveling guide
...
*/
module.exports.exec = async (message, args) => {
    // variables
    const _user = message.author
    const fetch = JSON.parse(await (await require('node-fetch')('https://kohri-api.vercel.app/level?get=' + args)).text())
    const res   = []
    const chk   = []
